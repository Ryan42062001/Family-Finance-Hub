...
Married-family HSA remediation complete — pending independent clean audit. Build, Windfall, and Your Plan now consume or evaluate the corrected family base and owner catch-up buckets, including uneven-spouse histories. Closure still requires independent review of the exact remediation commit. No database migration was required.
